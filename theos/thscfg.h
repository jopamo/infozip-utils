...
#ifdef FUNZIP
#define Info(buf, flag, sprf_arg) fprintf((flag) & 1 ? stderr : stdout, (char*)(_sprintf sprf_arg, (buf)))
#else
#define Info(buf, flag, sprf_arg) UzpMessagePrnt((zvoid*)&G, (uch*)(buf), (ulg)_sprintf sprf_arg, (flag))
#endif
#endif /* !Info */
#endif /* ?NO_BOGUS_SPC */
